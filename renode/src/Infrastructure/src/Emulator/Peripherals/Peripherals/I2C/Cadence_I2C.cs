    ...
    public class Cadence_I2C : SimpleContainer<II2CPeripheral>, IDoubleWordPeripheral, IKnownSize
    {
        ...
        private Dictionary<long, DoubleWordRegister> BuildRegisterMap()
        {
            return new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.IC_DEVICE_ID, new DoubleWordRegister(this).WithValueField(0,32, FieldMode.Read, valueProviderCallback: _ => 0xDEADBEEF)
                },
                {(long)Registers.IC_COMP_VERSION, new DoubleWordRegister(this).WithValueField(0,32, FieldMode.Read, valueProviderCallback: _ => 0x3230332A)
                },
                {(long)Registers.IC_COMP_TYPE, new DoubleWordRegister(this).WithValueField(0,32, FieldMode.Read, valueProviderCallback: _ => 0x44570140)
                }
            };
        }
