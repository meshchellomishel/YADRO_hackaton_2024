...
__attribute__((unused)) static bool ttable_compare_key_pointer(TTable_entry entry, const void *value)
{
    return entry.key == value;
}

__attribute__((unused)) static bool ttable_compare_key_string(TTable_entry entry, const void *value)
{
    return strcmp(entry.key, value) == 0;
}

__attribute__((unused)) static bool ttable_compare_key_uint32(TTable_entry entry, const void *value)
{
