...
inline void csr_write_helper(CPUState *env, target_ulong val_to_write, target_ulong csrno)
{
    ...
    case CSR_VCSR:
        ...
        break;
    case CSR_MPU_SELECT:
        env->mpu_select = val_to_write;
        break;
    case CSR_MPU_CONTROL:
        env->mpu_control = val_to_write;
        break;
    case CSR_MPU_ADDRESS:
        env->mpu_address = val_to_write;
        break;
    case CSR_MPU_MASK:
        env->mpu_mask = val_to_write;
        break;
    case CSR_MEM_CTRL_GLOBAL:
        env->mem_ctrl_global = val_to_write & CSR_MEM_CTRL_GLOBAL_MASK;
        break;
    default:
...
static inline target_ulong csr_read_helper(CPUState *env, target_ulong csrno)
{
    ...
    case CSR_VLENB:
        return env->vlenb;
    case CSR_MPU_SELECT:
        return env->mpu_select;
    case CSR_MPU_CONTROL:
        return env->mpu_control;
    case CSR_MPU_ADDRESS:
        return env->mpu_address;
    case CSR_MPU_MASK:
        return env->mpu_mask;
    case CSR_MEM_CTRL_GLOBAL:
        return env->mem_ctrl_global;
    default:
