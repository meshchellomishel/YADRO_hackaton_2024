...
struct CPUState {
    ...
    target_ulong priv;
    target_ulong mpu_select;
    target_ulong mpu_control;
    target_ulong mpu_address;
    target_ulong mpu_mask;
    target_ulong mem_ctrl_global;
...
#define V08(x,y) (env->vr[(x) * env->vlenb + y])
#define V16(x,y) (((V08(x,y) << 8) & 0xff00) | V08(x,y+1))
#define V32(x,y) (((V16(x,y) << 16) & 0xffff0000) | V16(x,y+2))
#define V64(x,y) ((((uint64_t)V32(x,y) << 32) & 0xffffffff00000000) | V32(x,y+4))
#define WR_V08(x,y,d) {V08(x,y) = d & 0xff;}
#define WR_V16(x,y,d) {V08(x,y) = (d >> 8) & 0xff; V08(x,y+1) = d & 0xff;}
#define WR_V32(x,y,d) {V08(x,y) = (d >> 24) & 0xff;V08(x,y+1) = (d >> 16) & 0xff;V08(x,y+2) = (d >> 8) & 0xff; V08(x,y+3) = d & 0xff;}
#define WR_V64(x,y,d) {V08(x,y) = (d >> 56) & 0xff;V08(x,y+1) = (d >> 48) & 0xff;V08(x,y+2) = (d >> 40) & 0xff;V08(x,y+3) = (d >> 32) & 0xff; \
                       V08(x,y+4) = (d >> 24) & 0xff;V08(x,y+5) = (d >> 16) & 0xff;V08(x,y+6) = (d >> 8) & 0xff;V08(x,y+7) = d & 0xff;}
